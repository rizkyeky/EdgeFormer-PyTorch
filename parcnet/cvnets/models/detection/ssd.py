...
class SingleShotDetector(BaseDetection):
    ...
    def forward(self, x: Tensor, is_predict=True) -> Union[DetectionPredTuple, Tuple[Tensor, Tensor, Tensor]]:
...
def nms(boxes: Tensor, scores: Tensor, nms_threshold: float, top_k: int = 200) -> Tuple[Tensor, Tensor]:
    """
    Args:
